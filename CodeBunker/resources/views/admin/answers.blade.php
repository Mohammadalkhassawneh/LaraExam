...
<div class="main-content">
    <div class="section__content section__content--p30">
        ...
        <div class="row">
                <div class="col-md-12">
                    <!-- DATA TABLE -->
                    <h3 class="title-5 m-b-35">Answers Table</h3>
                    <div class="table-data__tool">
                        ...
                        <a href="{{route('answer.create')}}"  style="float: right;"class="au-btn au-btn-icon au-btn--green au-btn--small">Add Answer</a>
                        </div>
                    </div>
                        ...
                        <table class="table table-data2">
                            ...
                            <tbody>
                                ...
                                <tr class="tr-shadow">
                                    ...
                                    <td class="desc">{{ $answer->question_id}}</td>
                                    <td class="desc">{{ $answer->exam_id}}</td>
