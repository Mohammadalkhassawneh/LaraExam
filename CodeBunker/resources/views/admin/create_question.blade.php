                        ...
                        <div class="card-body" style="margin:auto;">
                            ...
                            @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input  name="OptionOne" type="text" class="form-control" >
                                </div>
                                <div class="form-group">
                                    <label  class="control-label mb-1">option2</label>
                                    <input  name="OptionTwo" type="text" class="form-control" >
                                </div>
                                <div class="form-group">
                                    <label  class="control-label mb-1">option3</label>
                                    <input  name="OptionThree" type="text" class="form-control" >
                                </div>
                                <div class="form-group">
                                    <label  class="control-label mb-1">option3</label>
                                    <input  name="OptionFour" type="text" class="form-control" >
                                </div>
                                <div class="form-group has-success">
                                    <label  class="control-label mb-1">Answer</label>
                                    <input name="answer" type="text" class="form-control cc-name valid">
                                </div>
